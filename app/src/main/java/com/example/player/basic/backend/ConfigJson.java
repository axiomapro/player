...
public class ConfigJson {
    ...
    public void update(String linkCountry, String response) {
        try {
            ...
            Log.d(Config.log().basic(),"Успешно скопирован: "+linkCountry+".json");
            ...
            e.printStackTrace();
            Log.d(Config.log().basic(), "Не удалось копировать "+linkCountry+".json");
        } catch (JSONException e) {
            e.printStackTrace();
            Log.d(Config.log().basic(),"Не удалось получить "+linkCountry+".json");
        }
